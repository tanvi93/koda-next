...
@Component({
  selector: 'app-dragon-input-section',
  templateUrl: './dragon-input-section.component.html',
  styleUrls: ['./dragon-input-section.component.scss']
})
export class DragonInputSectionComponent implements OnInit, OnChanges {
  @Input() contentData;
  @Input() clearDataFlag;
