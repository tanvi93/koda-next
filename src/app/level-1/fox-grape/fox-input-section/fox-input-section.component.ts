...
@Component({
  selector: 'app-fox-input-section',
  templateUrl: './fox-input-section.component.html',
  styleUrls: ['./fox-input-section.component.scss']
})

  
/**
   * @name FoxInputSectionComponent<app-fox-input-section>
   ...
   * @memberOf FoxInputSectionComponent
   ...
   */
export class FoxInputSectionComponent implements OnInit, OnChanges {
  @Input() contentData;
  @Input() clearDataFlag;
