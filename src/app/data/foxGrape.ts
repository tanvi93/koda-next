...
export const foxGrapeContent = {
    instructionBarContent: 'Help me reach the grapes by telling me exactly how many steps to take.',
    question: 'Type in the number of steps that I should move.',
    inputParaContent1: 'Number of steps to the right of origin',
    inputParaContent2: 'Number of steps up from origin',
    mascotHead: 'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/mascot_head.png',
    popupMascotImage: 'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/mascot_head.png',
    actionbutton: 'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/move_button.png',
    mascotBg: '#ecd45c',
    BackgroundColor: '#ecd45c',
    foxImage: [
        'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/fox_front_sitting.png',
        'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/fox_front_standing.png',
        'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/fox_jumping.png',
        'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/fox_looking_at_user.png'
    ],
    grapeImage: 'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/grapes.png',
    backgroundImage: 'http://dqfevutdn6sxd.cloudfront.net/activities/fox_and_grapes/foxBg1.png',
