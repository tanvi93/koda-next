export const FormulaForRelativeContent = {
    ...
    meerkatMascot: 'http://dqfevutdn6sxd.cloudfront.net/monkey_menace/mascot_arms_folded_head.png',
    actionbutton: 'assets/images/move_button.png',
    backgroundImage: 'http://dqfevutdn6sxd.cloudfront.net/monkey_menace/screen-for-formula-for-relative.png',
    errorMsg: [
