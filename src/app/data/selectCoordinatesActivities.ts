export const selectCoordinatesContent = {
    headerContent: 'Complete all activities to earn your badge.',
    boyHead: 'assets/images/monkey_menace/mascot_arms_folded_head.png',
    ActivityContent: {
        coordinates: [
            {
            id: 0,
