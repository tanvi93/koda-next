export const checklistMCQ = {
    "mm3_1_q3": {
        ...
        "answer": [
            {
                "option": 'The cap keeps moving left/right and the monkey keeps throwing fruits.',
            ...
            {
                "option": 'The cap moves left/right only after the monkey has thrown a fruit.',
                // Message for the case when only this option is selected.
                "only_this_selected_msg": "No! It's not possible as the code for the monkey and the cap are not connected at all.",
            ...
            {
                "option": 'The cap moves left/right only after the monkey has moved to a new position.',
                "only_this_selected_msg": "That's not correct! The cap can still move left/right independent of monkey's position.",
                "right_and_this_selected_msg": "You're partly correct. Run your code again and observe carefully if the cap's movement gets affected by the monkey at all.",
                "isCorrect": false
            },
            {
                "option": 'The cap keeps moving left/right irrespective of what the monkey is doing.',
                "only_this_selected_msg": "You're right. Is there anything else that happens?",
                "isCorrect": true
            }
        ],
        ...
        "all_wrong_msg": "That's not true. The code of monkey and cap are not connected at all.",
