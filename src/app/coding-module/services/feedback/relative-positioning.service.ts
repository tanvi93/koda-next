...
export class RelativePositioningService {
  ...
  validateCode(blockList, codes, sprites, spriteStatus, callback) {
    ...
    if (((Number(inputXOfSecondBlock.input2) === -5 && Number(inputXOfSecondBlock.operator) === 0) || (Number(inputXOfSecondBlock.input2) === 5 && Number(inputXOfSecondBlock.operator) === 1)) && (Number(inputYOfSecondBlock.input2) === -5 && Number(inputYOfSecondBlock.operator) === 0) || (Number(inputYOfSecondBlock.input2) === 5 && Number(inputYOfSecondBlock.operator) === 1)) {
      this.success = true;
